...
function buildCharts(sample) {
  ...
  d3.json("./static/data/samples.json").then((data) => {
    ...
    // 3. Use Plotly to plot the data with the layout. Recall that data must be passed as an array. Layout is okay as an object.
    Plotly.newPlot("bubble", bubbleData, bubbleLayout); 
  });
  // samples.json no longer available after this point
}
